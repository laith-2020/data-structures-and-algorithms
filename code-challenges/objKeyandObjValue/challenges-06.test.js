...
const templatingWithMustache = () => {
    ...
    characters.forEach((item, idx) => {
        ...
        let mustTemplate = $('#template').html();
        let newObj = Mustache.render(mustTemplate, characters);
...
const getCourseKeys = (obj) => {
    // Solution code here...
    let courseKey = Object.keys(courseInfo);
    return courseKey;
};
...
Write a function named hasChildrenValues that uses Object.values to determine if any given character in the data set
 has children.
